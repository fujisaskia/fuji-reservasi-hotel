...
<div class="container mx-auto bg-white py-8 px-4 rounded-lg shadow-md border border-gray-300 text-sm md:text-xs">
    ...
    <div class="flex justify-center items-center mb-6">
        <div class="w-full max-w-md">
            <form action="{{ route('guest.checked_in') }}" method="GET" class="flex items-center">
        ...
        <table class="min-w-full bg-white border border-gray-200">
            <thead>
                <tr class="bg-rose-100">
                    ...
                    <th class="py-3 px-4 border-b border-gray-200 text-left font-semibold text-gray-600">No. Telp</th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="py-6 px-4 text-center text-gray-600 text-xs ">Tidak ada tamu ditemukan</td>
                    </tr>
                @endforelse
